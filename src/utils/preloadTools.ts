...
const toolChunkLoaders: Record<string, () => Promise<any>> = {
  ...
  '/extract-tables-from-pdf-to-excel': () => import('../tools/PDFToExcelTool'),
  '/pdf-bank-statement-to-excel': () => import('../tools/PDFToExcelTool'),
  '/invoice-pdf-to-excel': () => import('../tools/PDFToExcelTool'),
  '/financial-statement-pdf-to-excel': () => import('../tools/PDFToExcelTool'),
  '/multi-page-pdf-to-excel': () => import('../tools/PDFToExcelTool'),
  '/pdf-to-excel-on-iphone': () => import('../tools/PDFToExcelTool'),
  '/pdf-to-xlsx-online': () => import('../tools/PDFToExcelTool'),
  '/convert-pdf-data-to-excel': () => import('../tools/PDFToExcelTool'),
